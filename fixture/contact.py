...
class ContactHelper:
    ...
    def delete_first_contact(self):
        wd = self.app.wd
        self.app.open_home_page()
        self.first_contact_selection(wd)
        self.submit_first_contact_deletion(wd)


    def first_contact_selection(self, wd):
    ...
    def modify_first_contact(self, contact):
        wd = self.app.wd
        self.app.open_home_page()
        self.select_first_contact_edit_button(wd)
        self.fill_contact_form(contact, wd)
        self.submit_changes(wd)
        self.app.return_to_home_page()

    def select_first_contact_edit_button(self, wd):
        wd.find_element_by_xpath("//img[@alt='Edit']").click()

    def submit_changes(self, wd):
